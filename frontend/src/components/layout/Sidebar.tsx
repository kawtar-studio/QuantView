...
const navigation = [
    ...
    { name: "Markets", icon: Globe, active: false },
    { name: "Stocks", icon: TrendingUp, active: false },
    { name: "Watchlist", icon: Star, active: false },
    { name: "Portfolio", icon: Briefcase, active: false },
    { name: "Screener", icon: Search, active: false },
    { name: "Company Analysis", icon: Building2, active: false },
    { name: "Financials", icon: FileText, active: false },
    { name: "Economics", icon: Landmark, active: false },
    { name: "News & Research", icon: Newspaper, active: false },
    { name: "Quant Tools", icon: Sparkles, active: false },
    { name: "AI Insights", icon: Sparkles, active: false, beta: true },
...
const Sidebar = () => {
    return (
        <aside className="relative flex h-screen w-[280px] flex-col border-r border-white/10 bg-[#0B0B0F]/90 backdrop-blur-2xl">
            ...
            <nav className="relative flex-1 overflow-y-auto px-5 py-8">
                    ...
                    {navigation.map((item) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {item.beta && (
                                    <span className="ml-auto rounded-full bg-[#7C5CFF]/15 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-[#B6A4FF]">
                                        Beta
                                    </span>
                                )}
                            </button>
